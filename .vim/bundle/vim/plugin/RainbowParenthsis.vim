...
hi level2c ctermfg=blue guifg=blue
hi level3c ctermfg=gray guifg=gray
hi level4c ctermfg=green guifg=green
hi level5c ctermfg=cyan guifg=cyan
hi level6c ctermfg=red guifg=red
hi level7c ctermfg=magenta guifg=magenta
hi level8c ctermfg=black guifg=black
hi level9c ctermfg=gray guifg=gray
hi level10c ctermfg=green guifg=green
hi level11c ctermfg=brown guifg=brown
hi level12c ctermfg=blue guifg=blue
hi level13c ctermfg=red guifg=red
hi level14c ctermfg=cyan guifg=cyan
hi level15c ctermfg=magenta guifg=magenta
hi level16c ctermfg=brown guifg=brown
