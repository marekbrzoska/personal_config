...
vmap <silent> <F12> :python run_these_lines(mode='vis')<CR>
nnoremap <silent> <F12> :python run_this_file()<CR>
nnoremap <silent> <F11> :python set_breakpoint()<CR>
nnoremap <silent> <s-F11> :python clear_breakpoint()<CR>
nnoremap <F6> :call <SID>toggle_send_on_save()<CR>
